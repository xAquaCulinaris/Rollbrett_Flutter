...
class AuthService {
  ...
  Future register(String email, String password, String username, String stance) async {
    try {
      ...
      UserService.updateUser(user.uid, username, 'https://firebasestorage.googleapis.com/v0/b/rollbrett-rottweil-flutter.appspot.com/o/thumbnails%2F1a817c2a-0291-4af6-af22-4904fa72c12c?alt=media&token=1dec4a49-b478-4807-94c1-301bcc7f1727', stance);
      return _convertUser(user);
    } catch (signUpError) {
